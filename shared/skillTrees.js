...
export const SKILL_TREES = {
  ...
  earth: [
    ...
    { id: 'rune_root',       label: 'Root Rune',         type: 'spell',   tier: 2,  x: 0.45, prereqs: ['pebble_shot'],             description: 'Place a rune. Detonates on the first enemy to step in it.' },
    ...
    { id: 'bulwark_stance',  label: 'Bulwark Stance',    type: 'passive', tier: 7,  x: 0.2,  prereqs: ['geologic'],                description: 'Barriers gain +50% health. Bedrock activates faster near your own wall.', branchGroup: 'earth_fork', branch: 'bulwark' },
    { id: 'tectonic_focus',  label: 'Tectonic Focus',    type: 'passive', tier: 7,  x: 0.8,  prereqs: ['geologic'],                description: '+15% damage on Avalanche and Fissure. Offense over defense.', branchGroup: 'earth_fork', branch: 'tectonic' },
    { id: 'avalanche',       label: 'Avalanche',         type: 'spell',   tier: 8,  x: 0.5,  prereqs: ['bulwark_stance', 'tectonic_focus'], description: 'Massive slow boulder. Staggers. Ancient and unstoppable.' },
    { id: 'bedrock',         label: 'Bedrock',           type: 'passive', tier: 9,  x: 0.5,  prereqs: ['avalanche'],               description: 'Standing still 1.5s: +20% damage, reduced spell cost.' },
    { id: 'petrify',         label: 'Petrify',           type: 'spell',   tier: 10, x: 0.5,  prereqs: ['bedrock'],                 description: 'Encases enemy in stone 2.5s. Full CC. Long cast.' },
    { id: 'fossilize',       label: 'Fossilize',         type: 'passive', tier: 11, x: 0.5,  prereqs: ['petrify'],                 description: 'After Petrify breaks, enemy stays slowed 4s.' },
    { id: 'rune_seismic',    label: 'Seismic Rune',      type: 'spell',   tier: 11.5, x: 0.8, prereqs: ['fossilize'],              description: 'Powerful rune. Massive damage + stun in a huge radius.' },
    { id: 'fissure',         label: 'Fissure',           type: 'spell',   tier: 12, x: 0.5,  prereqs: ['fossilize'],               description: 'Split ground in a line. Airborne = +25% damage taken.' },
    { id: 'the_deep',        label: 'The Deep',          type: 'passive', tier: 13, x: 0.5,  prereqs: ['fissure'],                 description: 'Stone Launch automatically triggers a small Fissure.' },
    { id: 'terra_domain',    label: 'Terra Domain',      type: 'spell',   tier: 14, x: 0.5,  prereqs: ['the_deep'],                description: 'Domain: stone spires erupt randomly. 5s. You are immune.' },
    { id: 'tectonic',        label: 'Tectonic',          type: 'passive', tier: 15, x: 0.5,  prereqs: ['terra_domain'],            description: 'After Terra Domain, Bedrock activates instantly.' },
    { id: 'the_monolith',    label: 'The Monolith',      type: 'spell',   tier: 16, x: 0.5,  prereqs: ['tectonic'],                description: 'Hitscan. Visible 1s before firing. Hits like geology.', shouldReplace: 'stone_spire' },
  ],
};
