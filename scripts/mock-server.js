...
function makePlayer(id, overrides = {}) {
  return {
    ...
    yaw: 0,
    pitch: 0,
    equippedSpells: ['rune_magma', 'fireball', 'inferno_domain', 'god_ray', 'god_ray', 'lightning_strike', 'immolate', 'chain_lightning', 'eruption'],
    cooldowns: {},
    activeEffects: {},
    skillPoints: 983,
    unlockedNodes: ['ember_flick', 'fireball', 'spark_shot', 'rune_ember', 'cauterize', 'lightning_strike', 'immolate', 'chain_lightning', 'eruption', 'amaterasu', 'magma_dash', 'inferno_domain', 'god_ray', 'rune_magma'],
    kills: 0,
    ping: 5,
    ...overrides,
  };
